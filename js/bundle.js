...
function calc() {
	...
	function getDinamikInformation(selector) {
	...
	getDinamikInformation('#height');
	getDinamikInformation('#weight');
	getDinamikInformation('#age');
}
...
document.addEventListener("DOMContentLoaded", () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-06-15');
